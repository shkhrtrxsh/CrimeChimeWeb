      ...
      <Card>
        ...
        <TableContainer>
          <Table aria-label="simple table">
            ...
            <TableBody>
              {/* {corList.data && corList.data.map((cor) => (
                <TableRow key={user.id}>
                  <TableCell component="th" scope="row">{cor.name}</TableCell>
                  <TableCell align="left">{cor.address}</TableCell>
                  <TableCell align="left">{cor.cor_admon.name}</TableCell>
                  <TableCell align="left">{cor.corp_group_branch_phone}</TableCell>
                  <TableCell align="left">{cor.corp_group_mailing_address}</TableCell>
