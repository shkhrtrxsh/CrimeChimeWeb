...
<div className='left-side md:w-1/3 pt-10'>
        ...
        <Grid container spacing={2} justifyContent="center" sx={{ paddingY: 0}}>
          <Grid item xs={10} className='flex justify-center flex-col'>
            <Typography variant="h1" sx={{ textAlign: 'center'  }} className='font-bold pt-2 pb-2 text-3xl'>Robbery</Typography>
            <Typography variant="h1" sx={{ textAlign: 'center'  }} className='font-normal pt-2 pb-2 text-sm'>(Items stolen in public area)</Typography>
      ...
      <Typography variant="h6" className='font-normal px-10 text-left'>Attempted Robbery<br/><span className='text-left text-sm'>(goods were not stolen)</span></Typography>
      </div>
      <div className='flex flex-row justify-start md:justify-center  items-center my-4 pl-8'>
      
      <Checkbox checked={checked} onChange={handleChange} />
      <Typography variant="h6" className='font-normal px-10 text-left'>Robbery<br/><span className='text-left text-sm'>(goods were stolen)</span></Typography>
      </div>
  ...
  <MenuItem value='other'>Other</MenuItem>
      ...
      <div className=''>
       <Box className="flex justify-center items-end bg-yellow-300 text-black p-3 md:mt-20 mt-4">
