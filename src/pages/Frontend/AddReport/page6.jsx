      ...
      <Container>
        <Grid container spacing={2} justifyContent="center">
          ...
          <Typography
              variant="h2"
              align="center"
              style={{ fontWeight: 'bold', paddingBottom: '5px', fontSize: '18px', paddingLeft: '14px', paddingTop: '15px' }}
            >
              Select any one
            </Typography>
            <Box sx={{ display: 'flex', flexDirection: 'COLUMN', justifyContent: 'center', my: 6, pl: 2 }}>
              <FormControlLabel
